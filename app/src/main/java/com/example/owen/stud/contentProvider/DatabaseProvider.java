...
public class DatabaseProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.example.owen.stud.provider";
    ...
    public String getType(@NonNull Uri uri) {
        switch (uriMatcher.match(uri)) {
            case BOOK_DIR:
                return "vnd.android.cursor.dir/vnd.com.example.owen.stud." +
                        "provider.book";
            case BOOK_ITEM:
                return "vnd.android.cursor.item/vnd.com.example.owen.stud." +
                        "provider.book";
            case CATEGORY_DIR:
                return "vnd.android.cursor.dir/vnd.com.example.owen.stud." +
                        "provider.category";
